...
name: ux-wireframe
description: >-
  Execute the VirtualBoard Generate Wireframe (GWF) workflow (ux.wireframe / UX-WIREFRAME). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/ux_designer/UXDesigner-Generate_Wireframe.md by tools/sync_claude_plugin.py. -->
