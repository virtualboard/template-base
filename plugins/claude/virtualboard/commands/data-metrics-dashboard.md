...
description: >-
  Execute the VirtualBoard Generate Metrics Dashboard (GMD) workflow (data.metrics-dashboard / DATA-METRICS). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/data_engineer/DataEngineer-Generate_Metrics_Dashboard.md by tools/sync_claude_plugin.py. -->
