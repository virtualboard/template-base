---
name: frontend-component-story
description: >-
  Execute the VirtualBoard Generate Component Story (GCS) workflow (frontend.component-story / FRONTEND-STORY). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/frontend_dev/FrontendDeveloper-Generate_Component_Story.md by tools/sync_claude_plugin.py. -->
...
- ID: `frontend.component-story`
- Alias: `FRONTEND-STORY`
