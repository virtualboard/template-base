...
description: >-
  Execute the VirtualBoard Generate Accessibility Audit (GAA) workflow (frontend.accessibility-audit / FRONTEND-A11Y). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/frontend_dev/FrontendDeveloper-Generate_Accessibility_Audit.md by tools/sync_claude_plugin.py. -->
