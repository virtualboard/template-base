...
name: data-pipeline
description: >-
  Execute the VirtualBoard Generate Data Pipeline (GDP) workflow (data.pipeline / DATA-PIPELINE). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/data_engineer/DataEngineer-Generate_Data_Pipeline.md by tools/sync_claude_plugin.py. -->
