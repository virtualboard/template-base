...
description: >-
  Execute the VirtualBoard Generate API Endpoint (GAE) workflow (backend.api-endpoint / BACKEND-ENDPOINT). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/backend_dev/BackendDeveloper-Generate_API_Endpoint.md by tools/sync_claude_plugin.py. -->
