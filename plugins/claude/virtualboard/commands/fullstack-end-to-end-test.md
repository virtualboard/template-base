---
name: fullstack-end-to-end-test
description: >-
  Execute the VirtualBoard Generate End-to-End Test (GETE) workflow (fullstack.end-to-end-test / FULLSTACK-E2E). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/fullstack_dev/FullstackDeveloper-Generate_End_to_End_Test.md by tools/sync_claude_plugin.py. -->
