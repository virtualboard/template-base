...
description: >-
  Execute the VirtualBoard Generate Database Migration (GDM) workflow (backend.database-migration / BACKEND-MIGRATION). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/backend_dev/BackendDeveloper-Generate_Database_Migration.md by tools/sync_claude_plugin.py. -->
