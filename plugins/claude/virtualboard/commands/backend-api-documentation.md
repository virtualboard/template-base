...
description: >-
  Execute the VirtualBoard Generate API Documentation (BACKEND-API-DOCS) workflow (backend.api-documentation / BACKEND-API-DOCS). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/backend_dev/BackendDeveloper-Generate_API_Documentation.md by tools/sync_claude_plugin.py. -->
