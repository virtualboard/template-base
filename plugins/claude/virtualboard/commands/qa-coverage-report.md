...
description: >-
  Execute the VirtualBoard Generate Test Coverage Report (GTCR) workflow (qa.coverage-report / QA-COVERAGE). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/qa/QA-Generate_Test_Coverage_Report.md by tools/sync_claude_plugin.py. -->
...
- Create coverage report at `$VB_ROOT/reports/testing/coverage/TCR-{YYYY-MM-DD}-{feature-or-module}.md`
...
- Ensure `$VB_ROOT/reports/testing/coverage/` exists
...
Template source: `$VB_ROOT/templates/reports/html/qa-test-coverage.html`.
