...
description: >-
  Execute the VirtualBoard Generate Threat Model (GTM) workflow (security.threat-model / SECURITY-THREAT). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/security/Security-Generate_Threat_Model.md by tools/sync_claude_plugin.py. -->
...
Create document at `$VB_ROOT/reports/security/threat-models/TM-{YYYY-MM-DD}-{component}.md`:
...
**Architecture Diagram** (`$VB_ROOT/reports/security/threat-models/diagrams/TM-{component}-architecture.md`):
- System components and their relationships
- Network boundaries and zones
- Data flow paths

**Attack Tree Diagram** (`$VB_ROOT/reports/security/threat-models/diagrams/TM-{component}-attack-tree.md`):
...
- Offer to create separate mitigation features through
...
Template source: `$VB_ROOT/templates/reports/html/security-threat-model.html`.
