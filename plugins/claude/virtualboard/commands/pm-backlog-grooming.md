...
description: >-
  Execute the VirtualBoard Generate Backlog Grooming (`pm.backlog-grooming` / `PM-GROOM`) workflow (pm.backlog-grooming / PM-GROOM). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/pm/PM-Generate_Backlog_Grooming.md by tools/sync_claude_plugin.py. -->
