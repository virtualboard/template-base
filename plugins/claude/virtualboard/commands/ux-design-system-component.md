---
name: ux-design-system-component
description: >-
  Execute the VirtualBoard Generate Design System Component (GDS) workflow (ux.design-system-component / UX-DESIGN-SYSTEM). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/ux_designer/UXDesigner-Generate_Design_System_Component.md by tools/sync_claude_plugin.py. -->
...
- ID: `ux.design-system-component`
- Alias: `UX-DESIGN-SYSTEM`
...
Create design system at `$VB_ROOT/reports/design/systems/DS-{project-name}.md`:
...
Create JSON tokens at `$VB_ROOT/reports/design/systems/design-tokens.json`:
...
Template source: `$VB_ROOT/templates/reports/html/ux-design-system.html`.
