---
name: data-entity-relationship-diagram
description: >-
  Execute the VirtualBoard Entity Relationship Diagram (ERD) workflow (data.entity-relationship-diagram / DATA-ERD). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/data_engineer/DataEngineer-Generate_Entity_Relationship_Diagram.md by tools/sync_claude_plugin.py. -->
