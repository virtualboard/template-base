---
name: devops-deployment-checklist
description: >-
  Execute the VirtualBoard Generate Deployment Checklist (GDC) workflow (devops.deployment-checklist / DEVOPS-CHECKLIST). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/devops/DevOps-Generate_Deployment_Checklist.md by tools/sync_claude_plugin.py. -->
