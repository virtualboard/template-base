...
description: >-
  Execute the VirtualBoard Generate User Journey (GUJ) workflow (ux.user-journey / UX-JOURNEY). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/ux_designer/UXDesigner-Generate_User_Journey.md by tools/sync_claude_plugin.py. -->
