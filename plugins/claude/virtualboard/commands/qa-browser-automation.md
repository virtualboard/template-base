...
description: >-
  Execute the VirtualBoard Generate Browser Automation Tests (GBAT) workflow (qa.browser-automation / QA-BROWSER). Use when the user requests this named workflow.
---

<!-- Generated from prompts/agents/qa/QA-Generate_Browser_Automation_Tests.md by tools/sync_claude_plugin.py. -->
